...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_port', type=int, default=8890, help='visdom port of the web display')
        ...
        parser.add_argument('--prob_label_noise', type=float, default=0., help='randomly change the domain label for crippling the discriminator')
